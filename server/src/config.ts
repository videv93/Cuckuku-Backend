...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'Cuckcuku';
    ...
    'jhipster.mail.from' = 'Cuckcuku@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'Cuckcuku API';
    'jhipster.swagger.description' = 'Cuckcuku API documentation';
    ...
    'eureka.instance.appname' = 'Cuckcuku';
    'eureka.instance.instanceId' = 'Cuckcuku:${random.value}';

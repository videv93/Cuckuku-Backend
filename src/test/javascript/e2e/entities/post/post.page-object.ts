...
export class PostDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('cuckcukuApp.post.delete.question'));
...
export default class PostComponentsPage {
  ...
  async deletePost() {
    ...
    expect(await postDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/cuckcukuApp.post.delete.question/);
